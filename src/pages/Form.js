...
class Form extends Component {
  ...
  onSubmit = () => {
    const { nodes, loading, variable, separateNumber } = this.state;
    // console.log({ separateNumber });
    // const center = separatePoint(nodes, separateNumber);
    // console.log({ center });
    this.setState({
      loading: !loading,
    });
              ...
              <table>
                ...
                <tbody style={{ textAlign: "center" }}>
                  ...
                  <tr>
                    ...
                    <td>
                      {error["exponentialWithKIteration"].meanOfPercentageError}
                    </td>
                    <td>
                      {error["exponentialWithKIteration"].meanAbsoluteError}
                    </td>
                    <td>
                      {error["exponentialWithKIteration"].meanSquareError}
                    </td>
                    <td>
                      {error["exponentialWithKIteration"].rootMeanSquareError}
                    </td>
                  </tr>
                  {semiVarioGram["exponentialWithConstant"].length > 0 && (
                    <tr>
                      ...
                      <td>
                        {error["exponentialWithConstant"].meanOfPercentageError}
                      </td>
                      <td>
                        {error["exponentialWithConstant"].meanAbsoluteError}
                      </td>
                      <td>
                        {error["exponentialWithConstant"].meanSquareError}
                      </td>
                      <td>
                        {error["exponentialWithConstant"].rootMeanSquareError}
                      </td>
                    </tr>
                  )}
                </tbody>
